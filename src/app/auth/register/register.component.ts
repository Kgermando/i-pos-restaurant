...
export class RegisterComponent implements OnInit {
  ...
  constructor(
    ...
    private entrepriseLocalService: EntrepriseLocalService,
  ...
  async onSubmit() {
    try {
      if (this.formGroup.valid) {
        ...
        await this.entrepriseLocalService.createData(body).then(async (res) => {
          var dataUser = {
            entreprise_id: res.id!,
            fullname: res.manager,
            email: res.email,
          ...
          await this.userLocalService.createUser(dataUser).then(() => {
